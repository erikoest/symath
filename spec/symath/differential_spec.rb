...
module SyMath
  ...
  describe SyMath::Operation::Differential, ', error conditions' do
    ...
    it 'raises error on d(x, pi)' do
      expect { d(x, pi) }.to raise_error('Expected variable, got SyMath::Definition::Constant')
    end
  end

  describe SyMath::Operation::Differential, ', simple polynomials' do
    poly = {
  ...
  describe SyMath::Operation::Differential, ', exponential functions' do
    exp = {
  ...
  describe SyMath::Operation::Differential, ', errors' do
