...
module SyMath
  ...
  describe SyMath::Operation::DistributiveLaw, ', expand' do
    sums = {
      x*(1 + 3*y)                           => 3*x*y + x,
      -x*(-y - 3)                           => x*y + 3*x,
      -x*(x - 3)                            => - x**2 + 3*x,
  ...
  describe SyMath::Operation::DistributiveLaw, ', combine fractions' do
    sums = {
      1.to_m              => 1.to_m,
      2.to_m              => 2.to_m,
      a.to_m              => a.to_m,
  ...
  describe SyMath::Operation::DistributiveLaw, ', factorization' do
    poly = {
