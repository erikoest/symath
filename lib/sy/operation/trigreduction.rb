...
module Sy::Operation::TrigReduction
  ...
  def trig_reduct()
    ...
    res = act_subexpressions('trig_reduct')
    ...
    return res.nil? ? self : res
  end

  def trig_reduct_check_factors()
    pi = :pi.to_m
  ...
  def trig_reduct_sin_and_cos(off)
    return self unless trig_reduct_check_factors
  ...
  def trig_reduct_sin()
    return trig_reduct_sin_and_cos(0)
  end

  def trig_reduct_cos()
    return trig_reduct_sin_and_cos(1)
  end

  def trig_reduct_tan_and_cot(off, sign)
    return self unless trig_reduct_check_factors
  ...
  def trig_reduct_tan()
    return trig_reduct_tan_and_cot(0, 1)
  end
  
  def trig_reduct_cot()
    return trig_reduct_tan_and_cot(1, -1)
  end

  def trig_reduct_sec_and_csc(off)
    return self unless trig_reduct_check_factors
  ...
  def trig_reduct_sec()
    return trig_reduct_sec_and_csc(0)
  end
